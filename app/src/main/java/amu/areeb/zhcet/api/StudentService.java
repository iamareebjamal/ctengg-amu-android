...
public class StudentService {
    ...
    public static Call<StudentAttendance> getAttendanceCall(String fac_no){
        return retrofit.create(AttendanceAPI.class).loadAttendance(fac_no, BuildConfig.API_KEY);
    }

    public static Call<StudentResult> getResultCall(String fac_no, String en_no){
        return retrofit.create(ResultAPI.class).loadResult(fac_no, en_no, BuildConfig.API_KEY);
    }
}
